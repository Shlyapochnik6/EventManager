...
namespace EventManager.Persistence.Migrations
{
    ...
    [Migration("20230323104248_AddEntityConfigurations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventManager.Domain.Location", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("EventManager.Domain.Event", b =>
                {
                    b.HasOne("EventManager.Domain.Location", "Location")
                        .WithMany("Events")
                    ...
                    b.HasOne("EventManager.Domain.Speaker", "Speaker")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("EventManager.Domain.User", null)
                        .WithMany()
